...
class Acquisition(threading.Thread):
    ...
    def run(self):
        ...
        while self.running:
            ...
            cv2.imwrite(r"C:\Users\oazougagh\Desktop\Test\acquisition.py\frames\Facepic.png", frame)
            # print(frame)
    ...
    def safe_frames(self, frames_index):
        ...
        for time in frames_index:
            ...
            file_name = r"C:\Users\oazougagh\Desktop\Omar_path\frames\frame[{}].png".format(index)
